#ONLY ONE THE KING OF COMMITTIY:BotSellerBd
#INSTAGRAM : @BotSellerBd_developer
#YOUTUBE : @BotSellerBd_developer
#TELEGRAM : @BotSellerBd_developer
...
def newinfo(uid):
    try:
        url = f"https://info-api-murex.vercel.app/accinfo?key=OnyxOverlord1&uid={ADD-YOUR-UID}"
        response = requests.get(url)
...
def send_likes(uid):
    likes_api_response = requests.get(f"https://ofc-seven.vercel.app/like?server_name=bd&uid={uid}")
        ...
        while True:
            ...
            if senthi == True:
                ...
                clients.send(
                        self.GenResponsMsg(
                            f"""[C][B][1E90FF]╔══════════════════════════╗
[FFFFFF]Hello! Thank you for adding me 😊  
[FFFFFF]To see available commands:  
[FFFFFF]Just send any message or emoji! 😊  
[1E90FF]╠══════════════════════════╣
[FFFFFF]Are you interested in buying a bot? 🤖  
[FFFFFF]For tech support, message the developer 📩  
[FFD700]TELEGRAM : [FFFF00]@BotSellerBd_developer
[1E90FF]╚══════════════════════════╝""", idinv
                        )
                )
                senthi = False
            ...
            if "1200" in data.hex()[0:4]:
                ...
                if "8" in parsed_data["5"]["data"] and "data" in parsed_data["5"]["data"]["8"]:
                    ...
                    if uexmojiii == "DefaultMessageWithKey":
                        ...
                        clients.send(
                            self.GenResponsMsg(
                            f"""[FFFFFF][b][c]✨Welcome bro! I’m always ready to help you 😊  ✨[/b]

[FFFFFF][c]To check your available commands, just send:  

[00FF00][b][c]/🤔help[/b]

[FFD700][c]For support or to buy your own personal bot:  

[b][i][A5E2CFٍ]Instagram: @BotSellerBd_developer[/b]

[b][c][1E90FF] Telegram: @BotSellerBd_developer""",uid
                            )
                        )
                else:
                    pass  
...
[b][i][A5E2CFٍ]telegram: BotSellerBd_developer[/b]

[b][c][1E90FF]Instagram : IAMBotSellerBd_developer[FFFFFF]
 
[b][i][A5E2CFٍ]telegram: @BotSellerBd_developer[/b]

[b][c][1E90FF]Instagram : @BotSellerBd_developer[FFFFFF]
 
Enjoy the bot my friend.......

[C][B][FF6347] Developer    BotSellerBd_developer""", uid
                    )
                )
